...
<!-- Half Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('./img/cleaning/construction/slider/slider1.jpg');"></div>
 
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/cleaning/construction/slider/slider2.jpg');"></div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Construction & Remodeling Cleaning</h1>
        <p align="justify" style="margin:20px;">Get rid of the dust left behind after construction. You are
likely to have a lot of dust and debris hanging around, even when construction is done. We will
come quickly to detail clean it from top to bottom.</p>
