...
<!-- Half Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('./img/cleaning/window/slider/slider1.jpg');"></div>

            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/cleaning/window/slider/slider2.jpg');"></div>
    ...
    <div class="container">
        ...
        <p align="justify" style="margin:20px;">
         Indulge in high-quality window cleaning from bonded professionals. Our
cleaners use the best products to produce a gleaming, streak-free shine that will make yourwindow the focal point of any room. Trust us to remove the fingerprints, dust, grime, and streaks that can build up on glass.</p>
