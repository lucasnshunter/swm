...
<!-- Half Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('./img/gardening/slider/slider1.jpg');"></div>
              
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/gardening/slider/slider2.jpg');"></div>
 
            </div>
            <div class="item">
                <!-- Set the third background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/gardening/slider/slider3.jpg');"></div>
    ...
    <div class="container">
        ...
        <p align="justify" style="margin:20px;">We offer services that include Lawn Mowing and Lawn Cutting,
Grass Cutting, Hedge Trimming, Hedge Cutting and Pruning, Garden Clearance and Garden tidy
ups and Driveway and Patio Cleaning ( Jet Washing / Pressure Washing).</p>
