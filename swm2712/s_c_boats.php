...
<!-- Half Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('./img/cleaning/boats/slider/1.jpg');"></div>
 
            </div>
            <div class="item ">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/cleaning/boats/slider/2.jpg');"></div>
     
            </div>
            <div class="item">
                <!-- Set the 3 background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/cleaning/boats/slider/3.jpg');"></div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Boat Cleaning </h1>
        <p align="justify" style="margin:20px;">Weuse a range of products which gently "deep-clean", removing staining and
dirt effectively and safely, enhancing appearance and protecting fibreglass boats. We will
restore the finish to oxidised areas and surfaces around exhaust outlets and give it a long lasting
UV-resistant shine</p>
