...
<!-- Half Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('./img/painting/slider/slider1.jpg');"></div>
 
            </div>
            <div class="item">
                <!-- Set the second background image using inline CSS below. -->
                <div class="fill" style="background-image:url('./img/painting/slider/slider2.jpg');"></div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1>Painting</h1>
        <p align="justify" style="margin:20px;">We do residential and commercial painting, offering our clients qualified
professionals to perform the painting your establishment requires with the quality and
economy that fits your needs. For this we have appropriate tools, quality paints and especially
the experience acquired in residential and commercial paintings through the years!</p>
